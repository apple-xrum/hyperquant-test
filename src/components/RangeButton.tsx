...
const RangeButton = ({ name, value, currentPeriod }: PropsType) => {
  ...
  return (
    <button
      className={`${currentPeriod === value ? "text-white" : "text-primary-light"} flex w-16 min-w-16 cursor-pointer items-center justify-center rounded-full border-2 py-1 text-xs font-bold text-nowrap`}
